...
echo "Downloading Cardano Wallet $CARDANO_WALLET_TAG"

downloadBinaries $CARDANO_WALLET_TAG 'linux64'
downloadBinaries $CARDANO_WALLET_TAG 'macos64'
downloadBinaries $CARDANO_WALLET_TAG 'win64'
